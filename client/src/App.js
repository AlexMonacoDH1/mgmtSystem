  ...
  const updateEmployee = (id) => {
    Axios.put('http://localhost:3001/update', {
      ...
      setEmployeeList(employeeList.map((val) => { 
        return val.id === id ?
        {name: val.name, age: val.age, country: val.country, position: val.position, wage: newWage} : val
      }))
    })
  }
          ...
          return(
            <div className='employees'>
              ...
              <div className='update'>
                <input type="text" placeholder="0000" onChange={(e) => setNewWage(e.target.value)}/>
